...
echo $i" |"$cy"     bahauddin tayu pati jateng"$i"                              "
echo $i" |"$me"─────────────────────────────────────────────"$i"|"
echo $i" |"$pu" AUTHOR :"$k" bahauddin ganteng"$i"                         "
echo $i" |"$pu" FACEBOOK :"$ku" bahauddin tayu pati"$i"                   "
echo $i" |"$pu" FROM :"$cy"~ BENDOKATON TAYU PATI JATENG"$i"    "
echo $i" |"$cy"            ~ SANTAI WAE SLOW WAE YO BRO"$i"            "
echo $i" |"$pu" Contack WhatsApp :"$ku" 085726833815"$i"              "
echo $i" |"$pu" Blog :"$ku" http://cybernoobstayupati.blogspot.com/"$i""
echo $i"["$bi"•"$i"]"$me"#######################################################"$i"["$bi"•"$i"]"
echo
echo $i"##########################################   "
