...
echo "-----------------------------------------------------------"
toilet -f pagga " Bahauddin  "|lolcat
echo "-----------------------------------------------------------"
echo $me"[+]─────────────────────────────────────────────────────[+]"
...
echo $i"|"$me" 3"$i" |"$cy" BRUTEFORCE FB              "$i""$i"      "$cy" "$i" "
...
echo $i"#########################################"$i"    "$cy" "$i" "
echo $i"|"$me"18"$i" |"$cy" INSTALL BAHAN DULU COEG  "$i""$i"    "$cy" "$i" "
echo $i"|"$me"19"$i" |"$cy" KELUAR/EXIT PROGRAM      "$i""$i"    "$cy" "$i" "
echo $i"#########################################    "
echo
